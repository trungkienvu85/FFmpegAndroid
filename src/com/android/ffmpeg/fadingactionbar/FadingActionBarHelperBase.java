 ...
 */
package com.android.ffmpeg.fadingactionbar;
...
import com.android.ffmpeg.fadingactionbar.view.ObservableScrollView;
import com.android.ffmpeg.fadingactionbar.view.OnScrollChangedCallback;
...
public abstract class FadingActionBarHelperBase {
	...
	//
	// ObservableWebViewWithHeader webView = (ObservableWebViewWithHeader)
	// mContentView;
	...
	private void updateHeaderHeight(int headerHeight) {
		ViewGroup.LayoutParams params = (ViewGroup.LayoutParams) mMarginView
				.getLayoutParams();
